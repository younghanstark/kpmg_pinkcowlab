...
//Global variables
var video = document.getElementById("video"); //where we will put & test our video output
...
function gotDevices(deviceInfos) {
  document.getElementbyId("selectArea").show();
  ...
  setTimeout(
    () => {
      navigator.mediaDevices
        ...
        .then(gotStream)
        .then((video.onloadedmetadata = displayVideoDimensions))
        .catch((error) => {
...
function displayVideoDimensions() {
  console.log("displayVideoDimensions");
